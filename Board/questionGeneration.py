...
class questionGeneration:
    ...
    def multiplication(self):
        ...
        solution = a * b
        return [f"What is {a} x {b}?"," "," ",solution]
    ...
    def division(self):
        ...
        return [f"What is {a} / {b}?","Round to 2 decimal places"," ",solution]
    ...
    def linear(self):
        ...
        return [f"Determine the integral of the function given by",f"{a}x + {b}, use F^(-1)({c}) = {d} to find C", "Round to 2 decimal places",f"{round(a/2, 2)}x^2, {b}x + {constant}"]
