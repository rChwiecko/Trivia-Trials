...
class questionGeneration:
    ...
    def quadratic(self):
        ...
        return [f"Find the roots of the function given by", f"{first}x^2 + {second}x + {third}", "Round to 2 decimal places", first, second, third, roots]
    ...
    def linear(self):
        ...
        return [f"Determine the integral of the function given by", f"{a}x + {b}, use F^(-1)({c}) = {d} to find C", "Round to 2 decimal places",a,b,f"{round(a/2, 2)}x^2, {b}x + {constant}"]
