...
bg = pygame.transform.scale(pygame.image.load('transparentduck.png'), (300, 300))
ball = pygame.transform.scale(pygame.image.load('transparentduck.png'), (150, 150))
menu_command = 0
...
def draw_menu():
    ...
    txt = font.render('Trivia Trials', True, 'black')
    ...
    button1.draw()
    button2 = Button('Load Previous', (120, 240))
    button2.draw()
    button3 = Button('Highscore', (120, 300))
    button3.draw()
